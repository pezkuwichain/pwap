...
import { chains3dpassSVG, chainsAcalaSVG, chainsAlephSVG, chainsAllfeatSVG, chainsAnalogSVG, chainsArgonSVG, chainsBrainstormPNG, chainsChainflipPNG, chainsCreditcoinTestPNG, chainsDebioSVG, chainsEquilibriumSVG, chainsFerrumPNG, chainsFragnovaPNG, chainsJurPNG, chainsKintsugiPNG, chainsLiberlandPNG, chainsLogionPNG, chainsMyriadPNG, chainsPezkuwiPNG, chainsQfNetworkPNG, chainsSkyekiwiPNG, chainsTanglePNG, chainsVaraTestnetPNG } from '../ui/logos/chains/index.js';
...
export const testChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  {
    info: 'pezkuwi-testnet',
    providers: {
      Pezkuwi: 'wss://testnet.pezkuwichain.io'
    },
    text: 'Pezkuwi Testnet (Beta)',
    ui: {
      color: '#00A94F',
