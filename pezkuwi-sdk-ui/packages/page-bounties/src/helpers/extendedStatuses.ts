...
function validMethods (status: PezpalletBountiesBountyStatus): string[] {
...
export function getProposalToDisplay (bountyProposals: DeriveCollectiveProposal[], status: PezpalletBountiesBountyStatus): DeriveCollectiveProposal | null {
