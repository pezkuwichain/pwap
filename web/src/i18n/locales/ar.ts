export default {
  ...
  'p2pWithdraw.processingTime': 'وقت المعالجة: عادة خلال 5-30 دقيقة',
  ...
  'p2pWithdraw.trackInfo': 'يمكنك تتبع حالة السحب من سجل المعاملات. ستصل الأموال لمحفظتك خلال 5-30 دقيقة.',
