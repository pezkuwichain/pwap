...
const ReferralScreen: React.FC = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); fetchReferralData().finally(() => setRefreshing(false)); }} />}>
        {loading && (
        ...
        >
          <View style={styles.qrModalContainer}>
            <View style={styles.qrModalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowQRModal(false)} accessibilityRole="button" accessibilityLabel="Close QR code">
