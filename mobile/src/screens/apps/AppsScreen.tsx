...
const FEATURED_APPS: MiniApp[] = [
  {
    ...
    developer: 'Pezkuwi',
    category: 'Social',
    description: 'Neighborhood economy - food packages, meals, merchants',
    status: 'live',
  },
  {
    id: 'dapp-browser',
    ...
    developer: 'Pezkuwi',
    category: 'Tools',
    description: 'Browse Web3 dApps with wallet integration',
    status: 'live',
  },
  {
    id: 'governance',
    ...
    developer: 'Pezkuwi',
    category: 'Governance',
    description: 'Vote on referenda and proposals',
    status: 'live',
  },
  {
    id: 'pezkuwi-b2b-ai',
...
const AppsScreen: React.FC = () => {
  ...
  const renderMiniAppCard = (app: MiniApp) => (
    <TouchableOpacity
      ...
      onPress={() => {
        if (app.status === 'live') {
          if (app.id === 'bereketli') navigation.navigate('Bereketli');
          else if (app.id === 'dapp-browser') navigation.navigate('DAppBrowser');
          else if (app.id === 'governance') navigation.navigate('Governance');
          else Alert.alert(app.name, app.description);
        } else {
          Alert.alert(app.name, `${app.description}\n\nby ${app.developer}\n\nStatus: Coming Soon`);
        }
      }}
    >
      ...
      <View style={styles.miniAppInfo}>
        <View style={styles.miniAppHeader}>
          ...
          {app.status === 'coming_soon' ? (
            ...
            <View style={[styles.comingSoonBadge, { backgroundColor: 'rgba(0,143,67,0.1)' }]}>
              <Text style={[styles.comingSoonText, { color: KurdistanColors.kesk }]}>Live</Text>
            </View>
          )}
        </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); setTimeout(() => setRefreshing(false), 1000); }} />}>
        {/* Header */}
        <View style={styles.header}>
          <View style={styles.headerTop}>
            ...
            {!isConnected ? (
              <TouchableOpacity style={styles.connectButton} onPress={handleConnectWallet} accessibilityRole="button" accessibilityLabel="Connect wallet">
        ...
        <View style={styles.buildSection}>
          <View style={styles.buildContent}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              accessibilityRole="button"
              accessibilityLabel="Submit a new mini app"
            >
          ...
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity
                ...
                accessibilityRole="button"
                accessibilityLabel="Close submit modal"
              >
            ...
            <ScrollView style={styles.modalBody} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  autoCapitalize="none"
                  placeholderTextColor="#999"
                  accessibilityLabel="Project domain"
                />
              </View>
