...
const B2BScreen: React.FC = () => {
  ...
  const onRefresh = useCallback(async () => {
    setRefreshing(true);
    // Placeholder until Supabase/blockchain fetch is wired
  ...
  const handleCreateListing = async () => {
    ...
    // Persist to Supabase/blockchain when backend is ready
  ...
  const handleSendContact = async () => {
    ...
    // Message delivery via blockchain or Supabase pending backend
    Alert.alert(
      'Serketî / Success',
        ...
        { text: 'Betal / Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              // Escrow transaction via pallet_escrow
              Alert.alert(
                'Serketî / Success',
