...
const TaxZekatScreen: React.FC = () => {
  ...
  const confirmAndSend = async () => {
    ...
    try {
      ...
      logger.warn('[TaxZekat] Treasury account:', treasuryAccount.toString());
      logger.warn('[TaxZekat] Amount:', amountInUnits.toString());
      logger.warn('[TaxZekat] Remark:', remarkMessage);
    ...
    <View key={item.id} style={styles.allocationItem}>
      ...
      <View style={styles.allocationInput}>
        <TextInput
          ...
          maxLength={3}
          accessibilityLabel={`${item.nameEn} allocation percentage`}
        />
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); setTimeout(() => setRefreshing(false), 1000); }} />}>
        {/* Description */}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.typeSelector}>
            <TouchableOpacity
              ...
              accessibilityLabel="Select zekat contribution type"
            >
            ...
            <TouchableOpacity
              ...
              accessibilityRole="button"
              accessibilityLabel="Select tax contribution type"
            >
              <Text style={styles.typeIcon}>📜</Text>
              <Text style={[
                styles.typeText,
        ...
        <View style={styles.section}>
          ...
          <View style={styles.amountContainer}>
            <TextInput
              ...
              placeholder="0.00"
              placeholderTextColor="#999"
              accessibilityLabel="Contribution amount in HEZ"
            />
        ...
        <View style={styles.termsSection}>
          ...
          <TouchableOpacity
            ...
            accessibilityLabel="Accept terms and commitment"
          >
        ...
        <TouchableOpacity
          ...
          accessibilityRole="button"
          accessibilityLabel={contributionType === 'zekat' ? 'Submit zekat' : 'Submit tax'}
        >
          {isSubmitting ? (
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity
                ...
                accessibilityRole="button"
                accessibilityLabel="Confirm and send contribution"
              >
