...
const WalletSetupScreen: React.FC = () => {
  ...
  const handleCreateWallet = async () => {
    ...
    try {
      ...
      logger.error('[WalletSetup] Create wallet error:', error);
  ...
  const handleImportComplete = async () => {
    ...
    try {
      ...
      logger.error('[WalletSetup] Import wallet error:', error);
  ...
  const handleSuccess = () => {
    ...
    (navigation as NavigationProp<ParamListBase> & { replace: (screen: string) => void }).replace('Wallet');
  };
  ...
  const renderCreateShowStep = () => (
    <View style={styles.stepContainer} testID="wallet-setup-show-seed">
      ...
      <TouchableOpacity
        ...
        accessibilityRole="button"
        accessibilityLabel="I have written down the recovery phrase"
      >
            ...
            <View style={styles.verificationOptions}>
              {getShuffledOptions(mnemonic[wordIndex]).map((option, optIdx) => (
                <TouchableOpacity
                  ...
                  accessibilityRole="button"
                  accessibilityLabel={`Select word ${option}`}
                >
                  <Text style={[
  ...
  const renderImportStep = () => (
    <View style={styles.stepContainer} testID="wallet-setup-import">
      ...
      <TouchableOpacity
        ...
        accessibilityRole="button"
        accessibilityLabel="Continue with import"
      >
  ...
  const renderWalletNameStep = () => (
    <View style={styles.stepContainer} testID="wallet-setup-name">
      ...
      <TouchableOpacity
        ...
        accessibilityRole="button"
        accessibilityLabel={isCreateFlow ? 'Create wallet' : 'Import wallet'}
      >
        {isLoading ? (
  ...
  return (
    <SafeAreaView style={styles.container} testID="wallet-setup-screen">
      ...
      {step === 'choice' && (
        <View style={styles.header}>
          <TouchableOpacity onPress={() => navigation.goBack()} style={styles.closeButton} testID="wallet-setup-close" accessibilityRole="button" accessibilityLabel="Close wallet setup">
