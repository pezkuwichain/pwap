  ...
  return (
    <>
      <TouchableOpacity
        ...
        accessibilityLabel={`Select region, currently ${selectedOption?.label || 'none'}`}
      >
        ...
        >
          <View style={styles.pickerModal}>
            <View style={styles.pickerHeader}>
              ...
              <TouchableOpacity onPress={() => setIsVisible(false)} accessibilityRole="button" accessibilityLabel="Close region picker">
...
const BeCitizenApplyScreen: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      logger.error('Citizenship application error:', error);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.formContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholderTextColor="#999"
              accessibilityLabel="Grandfather's name"
            />
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholderTextColor="#999"
              accessibilityLabel="Mother's name"
            />
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          accessibilityRole="button"
          accessibilityLabel="Submit citizenship application"
        >
          {isSubmitting ? (
