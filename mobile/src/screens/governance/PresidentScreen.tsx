...
const PresidentScreen: React.FC = () => {
  ...
  useEffect(() => {
    const checkAccess = async () => {
      ...
      try {
        ...
        logger.error('[President] Error checking tiki:', error);
        setHasWelatiTiki(false);
      } finally {
        setCheckingAccess(false);
      }
  ...
  const fetchElectionData = useCallback(async () => {
    ...
    try {
      ...
      logger.error('[President] Error fetching elections:', error);
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
  ...
  const checkCandidateEligibility = async () => {
    ...
    try {
      ...
      logger.error('[President] Error checking eligibility:', error);
  ...
  const handleVote = async () => {
    ...
    try {
      ...
      logger.error('[President] Vote error:', error);
        ...
        >
          <View style={styles.accessDeniedContent}>
            ...
            <TouchableOpacity
              ...
              accessibilityLabel="Become a citizen"
            >
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        <TouchableOpacity
          ...
          accessibilityRole="button"
          accessibilityLabel="Election history tab"
        >
        ...
        <TouchableOpacity
          ...
          accessibilityRole="button"
          accessibilityLabel="Active elections tab"
        >
        ...
        <TouchableOpacity
          ...
          accessibilityRole="button"
          accessibilityLabel="Become candidate tab"
        >
                    ...
                    {candidates.length === 0 ? (
                      ...
                      candidates.map((candidate, index) => (
                        <TouchableOpacity
                          ...
                          accessibilityRole="button"
                          accessibilityLabel={`Vote for candidate ${formatAddress(candidate.account)}`}
                        >
                          ...
                          {!userHasVoted && selectedElection?.status === 'VotingPeriod' && (
                            <View style={styles.voteButton} accessibilityLabel="Vote for this candidate">
                    ...
                    <View style={[
                      ...
                      {eligibilityStatus.eligible && selectedElection?.status === 'CandidacyPeriod' && (
                        <TouchableOpacity
                          ...
                          accessibilityRole="button"
                          accessibilityLabel="Register as candidate"
                        >
